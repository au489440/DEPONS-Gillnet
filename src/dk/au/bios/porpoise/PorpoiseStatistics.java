...
public class PorpoiseStatistics extends Agent {
	...
	public void addDeath(final CauseOfDeath cause) {
		numDeaths++;
		...
		case Starvation:
			...
			break;
		default:
			throw new IllegalArgumentException("Unknown cause of death: " + cause.toString());
		}
	}
	...
	public int getNumberOfDeathsByByCatch() {
		return numDeathsByByCatch;
	}

	public int getNumberOfDeathsByOldAge() {
		return numDeathsByOldAge;
	}

	public int getNumberOfDeathsByStarvation() {
		return numDeathsByStarvation;
	}
